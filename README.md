## Minimal Docker image with Apache Tomcat [![Build Status](https://travis-ci.org/jeanblanchard/docker-busybox-tomcat.svg?branch=tomcat7java8)](https://travis-ci.org/jeanblanchard/docker-busybox-tomcat)
